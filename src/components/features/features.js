            ...
            <div className="features">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-4"><img className="img-fluid" src={icon_one} alt=""/></div>
                        <div className="col-4"><img className="img-fluid" src={icon_two} alt=""/></div>
                        <div className="col-4"><img className="img-fluid" src={icon_three} alt=""/></div>
                        <div className="col-4">
